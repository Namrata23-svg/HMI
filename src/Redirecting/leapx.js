...
import HMIT1 from "../assets/HMIT1.PNG"
import leapxImage from "../assets/leapx.png";
import HMIT2 from "../assets/HMIT2.PNG"
  ...
  const items = [
    {
      ...
      children: (
        <div style={{ display: "flex", width: "100%", margin: 0, padding: 0 }}>
          ...
          >
             <p style={{marginLeft:"1em"}}><b>Leapx Overview</b></p>
            <Card
              style={{
                marginBottom: "10px",
                cursor: "pointer",
