...
{/* <Card style={{height:"30%"}}> ?*/}
       ...
       <div style={{ display: 'flex', justifyContent: 'center' ,flexWrap:"wrap"}}>
        <div style={{ display: 'flex', flexDirection: 'row', gap: '20px' ,justifyContent:"centre",flexWrap:"wrap"}}>
        
      <Card style={{ width: isSmallScreen ? '100%' : (isMediumScreen ? '50%' : '300px') ,marginTop:"10px",cursor:"pointer"}} bodyStyle={{ padding: 0 }} hoverable
      ...
      onClick={() => navigate("/HMI")} className='card-hover' >
        ...
        <div className="custom-card">
          <h3 style={{textAlign:isSmallScreen ? "center" : "center",fontSize: isSmallScreen ? "16px" : "20px", // Adjust fontSize based on screen size
      marginTop: isSmallScreen ? "20px" : "40px",marginLeft:isSmallScreen ? "120px" : "0"}}>HMI Overview</h3>
      ...
      <Card  style={{width: isSmallScreen ? '100%' : (isMediumScreen ? '50%' : '300px') ,marginTop:"10px",cursor:"pointer"}} bodyStyle={{ padding: 0 }} hoverable
       onClick={() => navigate("/leapx")} className='card1-hover'>
        ...
        <div className="custom-card">
          <h3 style={{textAlign:"center",fontSize: isSmallScreen ? "16px" : "20px", // Adjust fontSize based on screen size
      marginTop: isSmallScreen ? "20px" : "40px",marginLeft:isSmallScreen ? "120px" : "0"}}>UX/UI</h3>
      ...
      onClick={() => navigate("/hmianalytics")} className='card2-hover'>
        ...
        <div className="custom-card">
          <h3 style={{textAlign:"center",fontSize: isSmallScreen ? "16px" : "20px", // Adjust fontSize based on screen size
      marginTop: isSmallScreen ? "20px" : "40px",marginLeft:isSmallScreen ? "120px" : "0"}}>HMI Software Development</h3>
          {/* <p>www.instagram.com</p> */}
        </div>
      </Card>
</div></div>
      ...
      <Card  style={{width: isSmallScreen ? '100%' : (isMediumScreen ? '50%' : '300px'),cursor:"pointer" }} bodyStyle={{ padding: 0 }} hoverable
       onClick={() => navigate("/hmivisualization")}  className='card3-hover'>
        ...
        <div className="custom-card">
          <h3 style={{textAlign:"center",fontSize: isSmallScreen ? "16px" : "20px", // Adjust fontSize based on screen size
      marginTop: isSmallScreen ? "20px" : "40px",marginLeft:isSmallScreen ? "120px" : "0"}}>HMI V&V Solutions</h3>
          {/* <p>www.instagram.com</p> */}
        </div>
      </Card>
      ...
      <Card  style={{ width: isSmallScreen ? '100%' : (isMediumScreen ? '50%' : '300px') ,cursor:"pointer"}} bodyStyle={{ padding: 0 }} hoverable
       onClick={() => navigate("/HmiAcc")}  className='card4-hover'>
        ...
        <div className="custom-card">
            <h3 style={{textAlign:"center",fontSize: isSmallScreen ? "16px" : "20px", // Adjust fontSize based on screen size
      marginTop: isSmallScreen ? "20px" : "40px",marginLeft:isSmallScreen ? "120px" : "0"}}>HMI Accelarators</h3>
      ...
      <Card  style={{width: isSmallScreen ? '100%' : (isMediumScreen ? '50%' : '300px') ,cursor:"pointer"}} bodyStyle={{ padding: 0 }} hoverable
      onClick={() => navigate("/HmiSoftwareProducts")}  className='card5-hover'>
        <div className="custom-image">
          <img alt="example" width="100%" src={Maya}/>
        </div>
        <div className="custom-card">
            <h3 style={{textAlign:"center",fontSize: isSmallScreen ? "16px" : "20px", // Adjust fontSize based on screen size
      marginTop: isSmallScreen ? "20px" : "40px",marginLeft:isSmallScreen ? "120px" : "0",paddingLeft:"30px"}}>HMI Software Products</h3>
